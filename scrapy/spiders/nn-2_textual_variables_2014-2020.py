...
for sublist in web_url:
    ...
    for url in tqdm(sublist):
        ...
        get_ipython().run_line_magic('time', 'doc_resp=get_content(url)')
        ...
        ############# Clean HTML tags and nondisplay section #####################
        get_ipython().run_line_magic('time', 'process_data(contents)')
...
get_ipython().run_cell_magic('bash', '', 'for i in {1..5}\ndo\n   echo "$i"\ndone')
